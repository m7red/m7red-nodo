...
function theme_options_add_page() {
	...
	add_theme_page( __( 'Theme Options', 'm7red' ), __( 'Theme Options', 'm7red' ), 'edit_theme_options', 'theme_options', 'theme_options_do_page' );
}
...
$navigation_options = array(
	'0' => array(
		'value' =>	'0',
		'label' => __( 'Standard', 'm7red' )
	),
	'1' => array(
		'value' => '1',
		'label' => __( 'InfiniteScroll', 'm7red' )
	)
);
...
$font_options = array(
	'0' => array(
		'value' =>	'0',
		'label' => __( 'Serif', 'm7red' )
	),
	'1' => array(
		'value' =>	'1',
		'label' => __( 'Sans Serif', 'm7red' )
	)
);
...
function theme_options_do_page() {
	...
	<div class="wrap">
		...
		<div class="updated fade"><p><strong><?php _e( 'Options saved', 'm7red' ); ?></strong></p></div>
		<?php endif; ?>
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><?php _e( 'Navigation', 'm7red' ); ?></th>
					<td>
						...
						<label class="description" for="imbalance2_theme_options[navigation]"><?php _e( 'Choose page navigation type', 'm7red' ); ?></label>
					</td>
				</tr>

				<tr valign="top"><th scope="row"><?php _e( 'Color', 'm7red' ); ?></th>
					<td>
...
jQuery(document).ready(function() {
	jQuery('#colorpicker').farbtastic('#imbalance2_theme_options_color');
						...
						<label class="description" for="imbalance2_theme_options_color"><?php _e( 'Select theme color', 'm7red' ); ?></label>
					</td>
				</tr>

				<tr valign="top"><th scope="row"><?php _e( 'Use images only', 'm7red' ); ?></th>
					<td>
						...
						<label class="description" for="imbalance2_theme_options[images_only]"><?php _e( 'For index page and related posts', 'm7red' ); ?></label>
					</td>
				</tr>

				<tr valign="top"><th scope="row"><?php _e( 'Related posts', 'm7red' ); ?></th>
					<td>
						...
						<label class="description" for="imbalance2_theme_options[related]"><?php _e( 'Enable related posts in Single page', 'm7red' ); ?></label>
					</td>
				</tr>

				<tr valign="top"><th scope="row"><?php _e( 'Font', 'm7red' ); ?></th>
					<td>
						...
						<label class="description" for="imbalance2_theme_options[font]"><?php _e( 'Choose font', 'm7red' ); ?></label>
					</td>
				</tr>

				<tr valign="top"><th scope="row"><?php _e( 'Google analytics', 'm7red' ); ?></th>
					<td>
						...
						<label class="description" for="imbalance2_theme_options[google]"><?php _e( 'Enter Google analytics code', 'm7red' ); ?></label>
					</td>
				</tr>

				<tr valign="top"><th scope="row"><?php _e( 'Favicon', 'm7red' ); ?></th>
					<td>
						...
						<label class="description" for="imbalance2_theme_options[favicon]"><?php _e( 'Enter favicon url, default will be used when value is not set', 'm7red' ); ?></label>
					</td>
				</tr>

				<tr valign="top"><th scope="row"><?php _e( 'Fluid grid', 'm7red' ); ?></th>
					<td>
						...
						<label class="description" for="imbalance2_theme_options[fluid]"><?php _e( 'Enable fluid grid', 'm7red' ); ?></label>
					</td>
				</tr>
			...
			<p class="submit">
				<input type="submit" class="button-primary" value="<?php _e( 'Save Options', 'm7red' ); ?>" />
			</p>
		</form>
	</div>
	<?php
